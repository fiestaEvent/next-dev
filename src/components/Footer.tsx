  ...
  return (
    <>
      <div className="flex-wrap border-t-2 pb-4 md:pb-0 border-t-fuchsia-900 w-full bg-fuchsia-900 text-[#fdfdfd] flex flex-col md:flex-row justify-center m-auto items-center align-middle lg:justify-evenly">
        ...
        <div className="flex flex-row items-center justify-evenly mx-auto w-full md:w-fit flex-wrap">
          <Image
            src="/logo_clean.png"
            alt="logo"
            width={100}
          ...
          <div className="flex flex-col lg:flex-row flex-wrap items-center mt-6 md:mx-auto">
            {contact.map((stat, index) => (
              <div
                className="p-2 lg:text-xl w-40 h-16 transition-all duration-200 m-1"
                key={index}
              >
          ...
          >
            <div className="">
              <svg
                ...
                height="32"
                viewBox="0 0 24 24"
                className="bx p-2 fill-fuchsia-900 bg-[#fdfdfd] rounded-full bxl-instagram"
              >
