...
export default function Landing() {
  return (
    <div className="section mt-36">
      <div className="absolute w-1/2 h-[100rem] bg-[#c1ae97] top-0 left-0 -z-30"></div>
      <div className="flex flex-col-reverse lg:flex-row justify-evenly items-center">
        <Image
          ...
          src="/logo.jpeg"
          // src="/logo_cleaned_"
          className="mt-20 lg:mt-0 h-64 w-64 md:h-96 md:w-96 border-[#c1ae97]"
          alt="logo"
          title="logo"
          loading="eager"
          placeholder="blur"
      ...
      <div className="flex flex-row mt-16 mb-12  justify-center text-center md:justify-evenly min-w-[50vw] max-w-[70vw] m-auto text-yellow-950">
        ...
        take our word for it - see what our satisfied clients have to say in our
      ...
      <div className="flex flex-col items-center -mb-12">
        ...
        <span className="text-3xl text-fuchsia-900 md:text-6xl mt-2 font-black">
          Fiesta
        </span>
      </div>
    </div>
